...
const industries = [
    {
        icon: Factory,
        title: "Manufacturing",
        description: "Comprehensive thermal solutions for manufacturing processes",
        features: ["Process Heating", "Temperature Control", "Heat Recovery"],
    ...
    },
    {
        ...
        description: "Precise thermal management systems for chemical reactions",
        features: ["Reactor Systems", "Process Safety", "Automation"],
    ...
    },
    {
        ...
        description: "Temperature-controlled environments for pharmaceutical manufacturing",
        features: ["Clean Room Systems", "Sterile Processing", "Compliance"],
    ...
    },
    {
        icon: Fuel,
        title: "Oil & Gas",
        description: "Thermal solutions for refining and processing applications",
        features: ["Heat Exchange", "Process Control", "Safety Systems"],
    ...
    },
    {
        icon: Leaf,
        title: "Green Energy",
        description: "Sustainable thermal management for renewable energy",
        features: ["Energy Efficiency", "Heat Recovery", "Sustainability"],
    ...
    },
    {
        icon: Building,
        title: "Commercial",
        description: "Custom HVAC solutions for commercial facilities",
        features: ["HVAC Systems", "Energy Management", "Maintenance"],
