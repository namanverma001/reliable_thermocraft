...
const Services = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white">
      <div className="container mx-auto py-8 sm:py-12 md:py-20">
        {/* Header */}
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <h2 className="text-blue-500 mb-2 sm:mb-4 font-libre text-xs sm:text-[18px] tracking-wider font-bold">
            OUR SERVICES
          </h2>
          <h3 className="text-2xl sm:text-4xl md:text-5xl lg:text-[48px] font-libre font-bold text-navy-900 tracking-tighter px-4">
        ...
        <div className="relative h-[500px] sm:h-[600px]">
          ...
          {/* Services Grid */}
          <div className="relative flex overflow-x-auto snap-x snap-mandatory font-libre hide-scrollbar">
            {services.map((service) => (
              <div
                key={service.id}
                className="relative flex-none w-full sm:w-1/2 md:w-1/3 lg:w-1/6 h-[500px] sm:h-[600px] snap-start group border-r border-white/10 overflow-hidden"
              ...
              >
                ...
                <div className="absolute inset-0 p-4 sm:p-8 flex flex-col">
                  ...
                  <button
                    ...
                    className={cn(
                      'w-8 h-8 sm:w-12 sm:h-12 rounded-full border-2 border-white/40 flex items-center justify-center',
                ...
                <div
                  className={cn(
                    'absolute left-0 right-0 bottom-0 bg-blue-600 p-4 sm:p-8 transition-transform duration-500 ease-in-out transform',
                    (activeId === service.id || isHovered === service.id)
                      ? 'translate-y-0'
                      : 'translate-y-full'
                  )}
                  style={{ height: '70%' }}
                >
                  <h4 className="text-white text-xl sm:text-2xl font-bold mb-2 sm:mb-4">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-white bg-white text-blue-600 text-sm sm:text-base py-1 px-3 sm:py-2 sm:px-4"
                  >
                    Learn more
                  </Button>
                </div>
